...
const recentUpdates = [
  ...
  },
  {
    ...
    time: "Apr 11, 2026 • 1:40 PM",
  },
  {
    title: "Additional document requested",
    description: "Please upload a corrected doctor’s prescription to continue the review process.",
    time: "Apr 12, 2026 • 10:05 AM",
  },
];
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                ...
                <h3 className="mt-2 text-xl font-bold text-slate-800">Doctor’s Prescription</h3>
                <p className="mt-3 text-sm leading-6 text-slate-600">
