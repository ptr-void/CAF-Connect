...
const guideSteps = [
  "Check the patientâ€™s possible eligibility using the guided screening form.",
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
          <div className="space-y-6">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-sky-100 to-emerald-100 p-8 border border-white/60 shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-emerald-100 to-sky-100 p-6 border border-white/60 shadow-lg">
