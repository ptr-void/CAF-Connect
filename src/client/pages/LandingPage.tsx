          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <button
                  onClick={() => setActivePage("eligibility")}
                  className="rounded-2xl bg-sky-600 px-6 py-3 font-semibold text-white transition hover:bg-sky-700"
                >
                  Check Eligibility
                </button>
                <button
                ...
                <button
                  onClick={() => setActivePage("tracker")}
                  className="rounded-2xl border border-slate-300 bg-white px-6 py-3 font-semibold text-slate-700 transition hover:border-sky-400 hover:text-sky-700"
                >
                  Track Application
                </button>
              </div>
        ...
        <section className="bg-white">
          <div className="mx-auto grid max-w-7xl gap-8 px-6 py-16 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-emerald-100 to-sky-100 p-8 shadow-sm ring-1 ring-emerald-200">
              ...
              <button
                onClick={() => setActivePage("help")}
                className="mt-8 w-full rounded-2xl bg-white px-5 py-3 font-semibold text-slate-800 transition hover:bg-slate-100"
              >
                Open Help & Support
              </button>
            </div>
          ...
          <div className="rounded-3xl bg-slate-900 px-8 py-12 text-white">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  onClick={() => setActivePage("auth")}
                  className="rounded-2xl border border-slate-600 px-6 py-3 font-semibold text-white transition hover:bg-slate-800"
                >
                  Sign In / Register
                </button>
              </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-sm text-slate-500">
              <button onClick={() => setActivePage("eligibility")} className="block hover:text-sky-700">
                Eligibility Checker
              </button>
              <button onClick={() => setActivePage("application")} className="block hover:text-sky-700">
                Patient Application
              </button>
              <button onClick={() => setActivePage("tracker")} className="block hover:text-sky-700">
                Application Tracker
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2">
              <button
                ...
                className="block text-sm text-slate-500 hover:text-sky-700"
              >
                Staff Dashboard
              </button>
              <button
